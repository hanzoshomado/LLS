	...
	public class LoadBalancingClient : IPhotonPeerListener
	{
		...
		public virtual void OnEvent(EventData photonEvent)
		{
			...
			case 230:
			{
				...
				{
					RoomInfo roomInfo = new RoomInfo(key, (Hashtable)hashtable3[key]);
			...
			case byte.MaxValue:
			{
				...
				if (player == null)
				{
					Player player2 = CreatePlayer(string.Empty, num3, false, hashtable2);
					CurrentRoom.StorePlayer(player2);
				}
				else
				{
					player.CacheProperties(hashtable2);
			...
			case 254:
			{
				...
				if (photonEvent.Parameters.ContainsKey(203))
				{
					...
					if (num != 0)
					{
						CurrentRoom.masterClientIdField = num;
					}
				}
				break;
			}
			case 253:
			{
				...
				Hashtable hashtable = (Hashtable)photonEvent[251];
				if (num2 > 0)
				{
					ReadoutProperties(null, hashtable, num2);
				}
				else
				{
					ReadoutProperties(hashtable, null, 0);
				}
				break;
			}
			case 226:
