...
public class iTween : MonoBehaviour
{
	...
	public static void ColorFrom(GameObject target, Hashtable args)
	{
		...
		// GUITexture/GUIText removed in modern Unity - fall through to Renderer/Light
	...
	{
		// GUITexture removed in modern Unity - CameraFade screen-overlay feature is disabled.
		// If the game relied on this for fade-to-black transitions, it will no longer visually fade.
		Debug.LogWarning("iTween: CameraFadeSwap is disabled (GUITexture no longer exists in modern Unity).");
	}
	...
	public static GameObject CameraFadeAdd(Texture2D texture, int depth)
	{
		...
		// GUITexture removed in modern Unity - CameraFade screen-overlay feature is disabled.
		Debug.LogWarning("iTween: CameraFadeAdd is disabled (GUITexture no longer exists in modern Unity).");
		return null;
	}
